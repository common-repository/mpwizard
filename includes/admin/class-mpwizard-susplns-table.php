 ...
 * @since 1.1.0
 */
class MPWizard_Susplns_Table extends WP_List_Table {
	...
	public function table_data()
	{
        ...
        while ( $loop->have_posts() ) {
		  ...
		  array_push($post_data, ['ID' => get_the_id(), 'button_name' => get_the_title(), 'shortcode' => get_the_id(), 'suscription_plan_link' => $init_point, 'created' => get_the_date( 'c' )]);  
	...
	public function get_columns() {
		...
		$columns = array(
			...
			'suscription_plan_link' =>	esc_html__( 'Suscription Plan Link', 'mpwizard' ),
